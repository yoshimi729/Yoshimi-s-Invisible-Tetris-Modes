...
## Cambridge Download
See [the Cambridge repository](https://github.com/cambridge-stacker/cambridge/releases/) for the application required to run these modes. Once installed, open the app and drop the files from this repository onto the window, choose "mode," and enjoy.
